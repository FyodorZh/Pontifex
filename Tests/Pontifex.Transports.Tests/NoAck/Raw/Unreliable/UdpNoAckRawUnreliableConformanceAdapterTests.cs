...
[TestFixture]
public sealed class UdpNoAckRawUnreliableConformanceTests : NoAckRawUnreliableConformanceTests
{
    protected override INoAckRawUnreliableConformanceAdapter CreateAdapter()
    {
        return new UdpNoAckRawUnreliableConformanceAdapter();
    }
}

public sealed class UdpNoAckRawUnreliableConformanceAdapterTests
{
    [Test]
    public void CreateFixture_CreatesUnstartedLinkedEndpoints()
    {
        using var fixture = new UdpNoAckRawUnreliableConformanceAdapter().CreateFixture(
    ...
    {
        var fixture = new UdpNoAckRawUnreliableConformanceAdapter().CreateFixture();
