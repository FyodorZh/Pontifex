...
{
    internal sealed class NoAckRawUnreliableToAckRawReliableClient : AnyTransport, IAckRawReliableClient
    {
        ...
        {
            private readonly INoAckRawUnreliableClient _inner;
            public SendConsumer(INoAckRawUnreliableClient inner) => _inner = inner;
        ...
        private sealed class ClientEndpoint : IAckRawReliableClientSideEndpoint
        {
            private readonly dm.DeliveryManager _dm;
            private readonly NoAckRawUnreliableToAckRawReliableClient _owner;
            private volatile bool _disconnected;

            public ClientEndpoint(dm.DeliveryManager dm, NoAckRawUnreliableToAckRawReliableClient owner)
            {
                _dm = dm;
                _owner = owner;
            }
        ...
        public NoAckRawUnreliableToAckRawReliableClient(
            INoAckRawUnreliableClient inner,
        ...
        protected override void OnStarted()
        {
            ...
            {
                IsBackground = true,
                Name = "NoAckRawUnreliableToAckRawReliableClient.DM"
            };
            _dmThread.Start();
        }
