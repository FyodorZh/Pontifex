...
{
    /// <summary>
    /// Base endpoint implementation for the RawUnreliableAck transport.
    /// The owning transport constructs this type and wires its send and stop delegates.
    /// </summary>
    public class RawUnreliableAckEndpoint : IRawUnreliableEndpoint
    {
        private readonly RawUnreliableAckTransport _owner;
        private readonly IRawUnreliableHandler _handler;
        private readonly IEndPoint? _remote;
        private readonly RawUnreliableAckEndpointConformanceControl _conformance = new();
        ...
        /// </summary>
        internal Func<RawUnreliableAckEndpoint, UnionDataList, SendResult>? SendDelegate;
        ...
        /// </summary>
        internal Func<RawUnreliableAckEndpoint, StopReason?, bool>? StopDelegate;

        internal RawUnreliableAckEndpoint(RawUnreliableAckTransport owner, IRawUnreliableHandler handler, IEndPoint? remote)
        {
            _owner = owner;
            _handler = handler;
            _remote = remote;
        ...
        public IRawUnreliableAckEndpointConformanceControl Conformance => _conformance;
