...
namespace Pontifex.Ack.Raw.Reliable.Logger
{
    public class AckRawReliableLoggerConstructor : ITransportConstructor
    {
        ...
        public ITransport ConstructClient(ITransportBuilder builder, IDescription description)
        {
            ...
            return new AckRawReliableClientLogger(builder.Build<IAckRawReliableClient>(nestedDesc));
        }
        ...
        public ITransport ConstructServer(ITransportBuilder builder, IDescription description)
        {
            ...
            return new AckRawReliableServerLogger(builder.Build<IAckRawReliableServer>(nestedDesc));
        }
