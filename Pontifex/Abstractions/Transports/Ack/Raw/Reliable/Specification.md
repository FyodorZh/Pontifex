# AckRawReliable Transport Specification

## 1. Scope

AckRawReliable is a bidirectional, connection-oriented transport contract for
...
or to a protocol layered above AckRawReliable.
...
| Topic | Guaranteed by AckRawReliable | Application responsibility | Implementation-defined |
| --- | --- | --- | --- |
...
operations: AckRawReliable clients and servers are single-use and MUST NOT be
...
run. AckRawReliable provides no application-visible message acknowledgement,
...
non-fatal, and a later send MAY succeed. AckRawReliable offers no
...
AckRawReliable treats ACK data, ACK responses, and regular messages as opaque
...
implement the required security protocol above AckRawReliable. Admission
