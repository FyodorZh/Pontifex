...
namespace Pontifex.Raw.Unreliable.Ack
{
    ...
    /// </summary>
    public interface IRawUnreliableAckClientHandler : IRawAckClientHandler
    {
        /// <summary>
        ...
        void OnConnected(IRawUnreliableAckClientSideEndpoint endPoint, UnionDataList ackResponse);
    }
}