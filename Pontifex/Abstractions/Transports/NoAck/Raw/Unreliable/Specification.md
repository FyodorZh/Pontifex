# NoAckRawUnreliable Transport Specification

## 1. Scope

NoAckRawUnreliable is a bidirectional, connectionless transport contract for
...
NoAckRawUnreliable has no connection, session, admission, handshake, peer
...
| Topic | Guaranteed by NoAckRawUnreliable | Application responsibility | Implementation-defined |
| --- | --- | --- | --- |
...
NoAckRawUnreliable provides no peer authentication, authorization,
