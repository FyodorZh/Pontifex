...
namespace Pontifex.Raw.Reliable.Ack.Reconnectable
{
    class ReconnectableClientLogic : ReconnectableBaseLogic<IRawReliableEndpoint>, IRawReliableAckClientHandler, IRawReliableEndpoint
    {
        ...
        public ReconnectableClientLogic(Func<IRawReliableAckClient?> underlyingTransportFactory, IRawReliableAckClientHandler userHandler, TimeSpan disconnectTimeout, 
        ...
        protected override bool BeginReconnect()
        {
            ...
            IRawReliableAckClient? transport = _underlyingTransportFactory.Invoke();
            if (transport == null)
            {
                return false;
            }
        ...
        #endregion IRawAckClientHandler
