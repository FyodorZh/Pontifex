...
{
    public sealed class RawReliableAckReconnectableClient : RawReliableAckClient, IRawReliableAckClient
    {
        private readonly Func<IRawReliableAckClient?> _underlyingTransportProducer;
        private readonly TimeSpan _disconnectTimeout;

        private ReconnectableClientLogic? _logic;
        private  ILogicDriver<IPeriodicLogicDriverCtl>? _logicDriver;

        public RawReliableAckReconnectableClient(
            Func<IRawReliableAckClient?> underlyingTransportProducer,
