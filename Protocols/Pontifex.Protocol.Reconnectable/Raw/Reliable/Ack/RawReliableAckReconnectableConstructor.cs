...
{
    public class RawReliableAckReconnectableConstructor : ITransportConstructor
    {
        ...
        public ITransport ConstructClient(ITransportBuilder builder, IDescription description)
        {
            ...
            return new RawReliableAckReconnectableClient(
                () => builder.Build<IRawReliableAckClient>(innerDesc),
                disconnectTimeout,
                builder.Logger,
        ...
        public ITransport ConstructServer(ITransportBuilder builder, IDescription description)
        {
            ...
            return new RawReliableAckReconnectableServer(builder.Build<IRawReliableAckServer>(nestedDesc), disconnectTimeout, builder.Logger, builder.MemoryRental);
        }
