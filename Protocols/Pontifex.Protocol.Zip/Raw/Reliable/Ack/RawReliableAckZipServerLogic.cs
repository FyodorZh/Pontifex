...
{
    class RawReliableAckZipServerLogic : CompressorLogic, IRawReliableAckWrapperServerLogic
    {
        public RawReliableAckZipServerLogic(ILogger logger, IMemoryRental memoryRental, int compressionLvl)
