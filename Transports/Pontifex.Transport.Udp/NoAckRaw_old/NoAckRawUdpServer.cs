...
{
    internal sealed class NoAckRawUdpServer : AnyTransport, INoAckRawServer, INoAckRawServerSideEndpoint
    {
        ...
        {
            // do nothing yet, but we can add controls here in the future if needed
        }
