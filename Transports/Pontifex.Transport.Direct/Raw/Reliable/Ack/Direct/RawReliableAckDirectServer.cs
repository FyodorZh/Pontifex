...
{
    public class RawReliableAckDirectServer : RawReliableAckServer, IRawReliableAckServer
    {
        ...
        public RawReliableAckDirectServer(string serverName, ILogger logger, IMemoryRental memory)
