...
namespace Pontifex.Raw.Reliable.Ack.Tcp
{
    internal class ServerSideSocket : IRawReliableAckServerSideEndpoint, IEquatable<ServerSideSocket>, IComparable<ServerSideSocket>
    {
        ...
        private IRawReliableAckServerHandler? _handler;
        ...
        private readonly Func<EndPoint, UnionDataList, IRawReliableAckServerHandler?> mAcknowledger;
        ...
        public ServerSideSocket(
            ...
            Func<EndPoint, UnionDataList, IRawReliableAckServerHandler?> acknowledger,
        ...
        #region Implementation of IRawAckClientEndpoint
