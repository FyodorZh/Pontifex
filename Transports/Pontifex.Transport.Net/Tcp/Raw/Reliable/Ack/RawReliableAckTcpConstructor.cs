...
{
    public class RawReliableAckTcpConstructor : ITransportConstructor
    {
        ...
        public ITransport ConstructServer(ITransportBuilder builder, IDescription description)
        {
            ...
            return new RawReliableAckTcpServer(ip, port, TcpInfo.ServerConnectionsLimit, disconnectionTimeout, null, builder.Logger, builder.MemoryRental);
        }
        ...
        public ITransport ConstructClient(ITransportBuilder builder, IDescription description)
        {
            ...
            return new RawReliableAckTcpClient(ip, port, disconnectionTimeout, null, builder.Logger, builder.MemoryRental);
        }
