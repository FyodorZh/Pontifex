...
{
    internal class RawReliableAckTcpServer : RawReliableAckServer, IRawReliableAckServer
    {
        private class ClientSet : PeriodicLogic
        {
            ...
            public void AddClient(Socket socket, Func<EndPoint, UnionDataList, IRawReliableAckServerHandler?> acknowledger, int messageMaxSize, IMemoryRental memoryRental, ILogger logger)
            {
            ...
            : base(TcpInfo.TransportName, logger, memoryRental)
        {
            ...
            {
                FailException("RawReliableAckTcpServer", ex);
                mClients = null!;
                mLocalEndPoint = null!;
        ...
        private IRawReliableAckServerHandler? TryAcknowledge(EndPoint ep, UnionDataList ackData)
        {
