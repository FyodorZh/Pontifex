    ...
    public class MethodBodyReader
    {
            ...
            while (position < il.Length)
            {
                ...
                switch (code.OperandType)
                {
                    ...
                    case OperandType.InlineType:
                        ...
                        instruction.Operand = null;//module.ResolveType(metadataToken, this.mi.DeclaringType.GetGenericArguments(), this.mi.GetGenericArguments());
                        break;
        ...
        public string GetBodyCode()
        {
            ...
            if (instructions != null)
            {
                ...
                {
                    result.Append(instructions[i].GetCode());
                    result.Append('\n');
                }
            }
            ...
            for (int i = 0, n = instructions.Count; i < n; ++i)
            {
                ...
                if (instruction.Code.OperandType == OperandType.InlineMethod)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (constructorInfo.Name == methodName)
                            {
                                return true;
                            }
                        }
        ...
        {
            if (Globals.singleByteOpCodes == null)
            {
                Globals.LoadOpCodes();
            }
